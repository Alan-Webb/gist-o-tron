...
const App = () => {
	...
	return (
		<div className="bg-cover bg-center bg-no-repeat bg-[url('../src/assets/blue-grid.webp')] min-h-screen bg-linear-to-br from-pink-950 via-stone-950 to-purple-900 flex flex-col items-center justify-center p-3 gap-6">

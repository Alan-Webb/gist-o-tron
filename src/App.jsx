...
const App = () => {
	...
	return (
		<div className="bg-[url('../src/assets/blue-grid.webp')] bg-cover min-h-screen flex flex-col items-center justify-center p-3 gap-6">
			<div className="uppercase font-extrabold text-center bg-linear-to-r from-sky-500 via-pink-500 to-indigo-500 bg-clip-text text-transparent">
				<h1 className="text-6xl sm:text-8xl">Gist-o-Tron</h1>
